return {
	-- Harpoon
	{
		...
		keys = {
			...
			{ "<leader>jm", function() require("harpoon").ui:toggle_quick_menu(require("harpoon"):list()) end, desc = "Harpoon menu" },
			{ "<leader>j1", function() require("harpoon"):list():select(1) end, desc = "Harpoon 1" },
			{ "<leader>j2", function() require("harpoon"):list():select(2) end, desc = "Harpoon 2" },
			{ "<leader>j3", function() require("harpoon"):list():select(3) end, desc = "Harpoon 3" },
			{ "<leader>j4", function() require("harpoon"):list():select(4) end, desc = "Harpoon 4" },
			{ "<leader>jp", function() require("harpoon"):list():prev() end, desc = "Harpoon prev" },
	...
	-- File browser
	{
		...
		keys = {
			...
			{ "<leader>-", ":<C-U>Oil<CR>", desc = "Oil parent directory", mode = { "n", "v" }, noremap = true, silent = true },
		},
		opts = {
			keymaps = {
